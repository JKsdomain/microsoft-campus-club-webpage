...
export const StorySections: React.FC = () => {
  return (
    <div className="space-y-0">
      {/* 1. IGNITE */}
      <section className="py-20 sm:py-28 bg-gradient-to-b from-[#07111F] via-[#0D1B2A]/60 to-[#07111F] border-t border-white/5 relative overflow-hidden">
        ...
        <Container>
          <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
            ...
            <span className="text-xl sm:text-2xl lg:text-3xl font-semibold tracking-[0.25em] text-[#0078D4] uppercase mb-6">
              YOUR PASSION
            </span>
      ...
      {/* 2. INNOVATE */}
      <section className="py-20 sm:py-28 bg-[#0D1B2A]/80 border-t border-white/5 relative overflow-hidden">
        ...
        <Container>
          <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
            ...
            <span className="text-xl sm:text-2xl lg:text-3xl font-semibold tracking-[0.25em] text-[#22D3EE] uppercase mb-6">
              WITHOUT LIMITS
            </span>
      ...
      {/* 3. IMPACT */}
      <section className="py-20 sm:py-28 bg-[#07111F] border-t border-white/5 relative overflow-hidden">
        <Container>
          <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
            <h2 className="text-5xl sm:text-7xl lg:text-8xl font-black tracking-tight text-[#F8FAFC] leading-none mb-3">
              IMPACT
            </h2>
            <span className="text-xl sm:text-2xl lg:text-3xl font-semibold tracking-[0.25em] text-[#CBD5E1] uppercase mb-6">
              WHAT MATTERS
            </span>
      ...
      {/* 4. CONNECT */}
      <section className="py-20 sm:py-28 bg-gradient-to-b from-[#07111F] via-[#0D1B2A] to-[#07111F] border-t border-b border-white/5 relative overflow-hidden">
        ...
        <Container>
          <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
            ...
            <p className="text-base sm:text-lg text-[#CBD5E1] max-w-2xl leading-relaxed font-normal mb-8">
